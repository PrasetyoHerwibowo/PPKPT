                            ...
                            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p class="text-sm text-slate-700 dark:text-slate-400">
                                        Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium"><?= min(10, count($laporan)) ?></span> dari <span class="font-medium"><?= count($laporan) ?></span> hasil
                                    </p>
                                </div>
                                <div>
